      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <form onSubmit={onSubmit} className="grid gap-4 rounded-2xl border border-white/10 bg-slate-900/60 p-6">
            ...
            <label className="grid gap-1 text-sm"><span>Branche/Gewerk</span>
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-6">
            <div className="aspect-video w-full rounded-lg bg-black/40 border border-white/10 flex items-center justify-center text-slate-400 text-sm">Calendly/Video Platzhalter</div>
            <ul className="mt-4 text-sm text-slate-300 list-disc pl-5 space-y-1">
              <li>Direkte Terminbuchung mit 2 Klicks</li>
              <li>Automatische Kalender-Einladungen</li>
              <li>Optionale Erinnerungen per SMS/E-Mail</li>
            </ul>
          </div>
        </div>
      </main>
